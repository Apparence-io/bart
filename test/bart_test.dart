...
void main() {
  group('Bart navigation with 3 items + subroutes', () {
    ...
    testWidgets('page has no app bar, click on add appbar => an appbar exists',
        (WidgetTester tester) async {
      await tester.pumpWidget(createM3App(initialRoute: "/library"));
      await tester.pump();
    ...
    testWidgets('default tab is the first one', (WidgetTester tester) async {
      await tester.pumpWidget(createM3App());
      var currentPage =
    ...
    testWidgets(
      ...
      final materialBottomBar =
          tester.firstWidget(find.byType(BartMaterial3BottomBar))
              as BartMaterial3BottomBar;
